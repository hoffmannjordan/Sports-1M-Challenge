        ...
        if self.load_in == True:
            ...
            def load(directory):
                ...
                for file in files:
                    ...
                    index.append(int(file.split('/')[-1].split('.')[0].split('_')[4])) #was 2
            ...
            train_set_x,train_set_y = load('../train_data_10_rgb_2')            
            test_set_x,test_set_y = load('../test_data_10_rgb_2')  
            ...
            #exit()
            for n in xrange(len(rand_val)-1):
